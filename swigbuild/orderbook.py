...
class limit_map(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _orderbook.limit_map_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _orderbook.limit_map___nonzero__(self)

    def __bool__(self):
        return _orderbook.limit_map___bool__(self)

    def __len__(self):
        return _orderbook.limit_map___len__(self)
    def __iter__(self):
    ...
    def __getitem__(self, key):
        return _orderbook.limit_map___getitem__(self, key)

    def __delitem__(self, key):
        return _orderbook.limit_map___delitem__(self, key)

    def has_key(self, key):
        return _orderbook.limit_map_has_key(self, key)

    def keys(self):
        return _orderbook.limit_map_keys(self)

    def values(self):
        return _orderbook.limit_map_values(self)

    def items(self):
        return _orderbook.limit_map_items(self)

    def __contains__(self, key):
        return _orderbook.limit_map___contains__(self, key)

    def key_iterator(self):
        return _orderbook.limit_map_key_iterator(self)

    def value_iterator(self):
        return _orderbook.limit_map_value_iterator(self)

    def __setitem__(self, *args):
        return _orderbook.limit_map___setitem__(self, *args)

    def asdict(self):
        return _orderbook.limit_map_asdict(self)

    def __init__(self, *args):
        _orderbook.limit_map_swiginit(self, _orderbook.new_limit_map(*args))

    def empty(self):
        return _orderbook.limit_map_empty(self)

    def size(self):
        return _orderbook.limit_map_size(self)

    def swap(self, v):
        return _orderbook.limit_map_swap(self, v)

    def begin(self):
        return _orderbook.limit_map_begin(self)

    def end(self):
        return _orderbook.limit_map_end(self)

    def rbegin(self):
        return _orderbook.limit_map_rbegin(self)

    def rend(self):
        return _orderbook.limit_map_rend(self)

    def clear(self):
        return _orderbook.limit_map_clear(self)

    def get_allocator(self):
        return _orderbook.limit_map_get_allocator(self)

    def count(self, x):
        return _orderbook.limit_map_count(self, x)

    def erase(self, *args):
        return _orderbook.limit_map_erase(self, *args)

    def find(self, x):
        return _orderbook.limit_map_find(self, x)

    def lower_bound(self, x):
        return _orderbook.limit_map_lower_bound(self, x)

    def upper_bound(self, x):
        return _orderbook.limit_map_upper_bound(self, x)
    __swig_destroy__ = _orderbook.delete_limit_map

# Register limit_map in _orderbook:
_orderbook.limit_map_swigregister(limit_map)
...
class idk(object):
    ...
    def __getitem__(self, key):
        return _orderbook.idk___getitem__(self, key)

    def __delitem__(self, key):
        return _orderbook.idk___delitem__(self, key)

    def has_key(self, key):
        return _orderbook.idk_has_key(self, key)

    def keys(self):
        return _orderbook.idk_keys(self)

    def values(self):
        return _orderbook.idk_values(self)

    def items(self):
        return _orderbook.idk_items(self)

    def __contains__(self, key):
        return _orderbook.idk___contains__(self, key)

    def key_iterator(self):
        return _orderbook.idk_key_iterator(self)

    def value_iterator(self):
        return _orderbook.idk_value_iterator(self)

    def __setitem__(self, *args):
        return _orderbook.idk___setitem__(self, *args)

    def asdict(self):
        return _orderbook.idk_asdict(self)
    ...
    def count(self, x):
        return _orderbook.idk_count(self, x)

    def erase(self, *args):
        return _orderbook.idk_erase(self, *args)

    def find(self, x):
        return _orderbook.idk_find(self, x)

    def lower_bound(self, x):
        return _orderbook.idk_lower_bound(self, x)

    def upper_bound(self, x):
        return _orderbook.idk_upper_bound(self, x)
